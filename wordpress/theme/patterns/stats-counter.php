...
/**
 * Title: Stats Counter
 * Slug: elevation-theme/stats-counter
 * Categories: featured
...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"backgroundColor":"gray-900","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-gray-900-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50)">
...
<p class="has-text-align-center has-gray-300-color has-text-color has-sm-font-size">Projects Completed</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center","textColor":"gray-300","fontSize":"sm"} -->
<p class="has-text-align-center has-gray-300-color has-text-color has-sm-font-size">Years Experience</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center","textColor":"gray-300","fontSize":"sm"} -->
<p class="has-text-align-center has-gray-300-color has-text-color has-sm-font-size">Design Awards</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center","textColor":"gray-300","fontSize":"sm"} -->
<p class="has-text-align-center has-gray-300-color has-text-color has-sm-font-size">Client Satisfaction</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
</div>
