...
<p class="has-gray-500-color has-text-color">Architecture &amp; Interior Design<br>Denver, Colorado</p>
<!-- /wp:paragraph -->

<!-- wp:social-links {"iconColor":"gray-500","iconColorValue":"#6b7280","className":"is-style-logos-only","style":{"spacing":{"margin":{"top":"var:preset|spacing|30"}}}} -->
...
<!-- wp:heading {"level":4,"textColor":"white","fontSize":"base"} -->
<h4 class="wp-block-heading has-white-color has-text-color has-base-font-size">Quick Links</h4>
<!-- /wp:heading -->

<!-- wp:list {"textColor":"gray-500","style":{"typography":{"lineHeight":"2"},"spacing":{"padding":{"left":"0"}}}} -->
<ul class="has-gray-500-color has-text-color" style="line-height:2;padding-left:0">
...
<div class="wp-block-column" style="flex-basis:25%">
<!-- wp:heading {"level":4,"textColor":"white","fontSize":"base"} -->
<h4 class="wp-block-heading has-white-color has-text-color has-base-font-size">Contact</h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"gray-500"} -->
<p class="has-gray-500-color has-text-color">hello@elevationdesign.co<br>(303) 555-0123</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"gray-500"} -->
<p class="has-gray-500-color has-text-color">1234 Design District<br>Denver, CO 80202</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
</div>
...
<!-- wp:separator {"style":{"spacing":{"margin":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|40"}}},"backgroundColor":"gray-500"} -->
<hr class="wp-block-separator has-text-color has-gray-500-color has-alpha-channel-opacity has-gray-500-background-color has-background" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:var(--wp--preset--spacing--40)"/>
<!-- /wp:separator -->
