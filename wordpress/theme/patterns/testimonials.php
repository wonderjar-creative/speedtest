...
<p class="has-gray-900-color has-text-color" style="font-style:italic">"Elevation Design transformed our dated living space into a modern oasis. Their attention to detail is unmatched."</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"gray-500","fontSize":"sm"} -->
<p class="has-gray-500-color has-text-color has-sm-font-size">— Sarah M., Denver</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<div class="wp-block-group has-gray-100-background-color has-background" style="border-radius:8px;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40)">
<!-- wp:paragraph {"style":{"typography":{"fontStyle":"italic"}},"textColor":"gray-900"} -->
<p class="has-gray-900-color has-text-color" style="font-style:italic">"Professional, creative, and easy to work with. Our new office space has boosted team morale significantly."</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"gray-500","fontSize":"sm"} -->
<p class="has-gray-500-color has-text-color has-sm-font-size">— James T., Boulder</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
