...
/**
 * Title: About Preview
 * Slug: elevation-theme/about-preview
 * Categories: featured
 * Keywords: about, preview, studio
 *
...
<figure class="wp-block-image has-custom-border"><img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=800&amp;q=80" alt="Elevation Design Studio team at work" style="border-radius:8px;aspect-ratio:4/3;object-fit:cover"/></figure>
<!-- /wp:image -->
</div>
<!-- /wp:column -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Denver's Award-Winning Design Studio</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"gray-500"} -->
<p class="has-gray-500-color has-text-color">For over 15 years, Elevation Design Studio has been transforming homes and commercial spaces across Colorado. Our team of architects and designers brings creativity, precision, and a deep understanding of how people live and work.</p>
<!-- /wp:paragraph -->
