...
<h2 class="wp-block-heading has-text-align-center has-white-color has-text-color">Visit Our Studio</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"gray-300","fontSize":"lg"} -->
<p class="has-text-align-center has-gray-300-color has-text-color has-lg-font-size">1234 Design District &bull; Denver, CO 80202</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center","textColor":"gray-300"} -->
<p class="has-text-align-center has-gray-300-color has-text-color">Mon-Fri 9am-6pm &bull; Sat by appointment</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
