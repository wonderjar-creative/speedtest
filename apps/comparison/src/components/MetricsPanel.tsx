    ...
    <section className="bg-surface border-y border-surface-alt py-6 px-4">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="text-center text-foreground/40 text-xs mt-1">
          Same Hetzner CX22 · Same WordPress backend · No CDN · Architecture is the only difference.
          <span
            className="ml-1.5 cursor-help underline decoration-dotted underline-offset-2"
            title="Both sites run on a single Hetzner CX22 (~$5/mo). Same WordPress 6.7 backend with WPGraphQL serving both sides. No edge cache, no CDN proxy in front — the gap reflects architecture only."
          >
            ⓘ
          </span>
        </p>
